              ...
              <div class="card">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  ...
                  <h6 class="m-0 font-weight-bold text-primary">Ürün Kategorileri</h6>
                     ...
                     <a href="urun-kategoriekle.php"><button class="btn btn-info">Kategori Ekle</button></a>
                    ...
                    <tbody>
                     ...
                     $sayac++;
                      ...
                      <tr>
                        ...
                        <td>
                       <a href="ayar/islem.php?urun-kategorisil=ok & kategori_id=<?= $kategoricek['kategori_id'] ?>"><span onclick="return confirm('Silme işlemini onaylıyor musun ? (Geri alınamaz)')" class="btn btn-danger btn-sm">Sil</span></a>
                        </td>
